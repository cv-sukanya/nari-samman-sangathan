...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/avenix/sermons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2024 11:38:37 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
	...
	<!-- Page Title -->
    <title>Naari Samman Sanghatana</title>
	<!-- Favicon Icon -->
			...
			<nav class="navbar navbar-expand-lg">
				<div class="container">
					...
					<a class="navbar-brand" href="index.html">
						<img src="images/naari_samman_sanghatana-logo.png" alt="Logo">
					</a>
					<!-- Logo End -->
			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime-style-2" data-cursor="-opaque">sermons</h1>
    ...
    <div class="page-sermons">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Sermons Item Start -->
                    <div class="sermons-item wow fadeInUp" data-wow-delay="0.75s">
                        <!-- Sermons Image Start -->
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Sermons Item Start -->
                    <div class="sermons-item wow fadeInUp" data-wow-delay="1s">
                        <!-- Sermons Image Start -->
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- Sermons Item Start -->
                    <div class="sermons-item wow fadeInUp" data-wow-delay="1.25s">
                        <!-- Sermons Image Start -->
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                                    <img src="images/sermons-img-6.jpg" alt="">
                                </a>
                            </figure>
                            <!-- Sermons Meta Start -->
                            <div class="sermons-meta">
                        ...
                        <div class="sermons-body">
                            <!-- Sermons Title Start -->
                            <div class="sermons-title">
                                <h2>the call to discipleship</h2>
                            </div>
                            <!-- Sermons Title End -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="about-footer">
                        ...
                        <div class="footer-logo">
                            ...
                            <img src="images/naari_samman_sanghatana-logo.png" alt="">
                        </div>
                        <!-- Footer Logo End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="footer-copyright-text">
                            <p>Copyright 2024 Naari Samman Sanghatan. All Rights Reserved.</p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <div class="footer-privacy-policy">
                            <ul>
                                <li style="color: #fff;">Designed By <a href="#" style="text-decoration: underline;">Chronicle Ventures</a></li>
                                <!-- <li><a href="#">support</a></li>
                                <li><a href="#">privacy policy</a></li> -->
                            </ul>
                            <!-- <p>Designed By <a href="#">Chronicle Ventures</a></p> -->
                        </div>
...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/avenix/sermons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2024 11:38:40 GMT -->
</html>