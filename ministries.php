...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/avenix/ministries.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2024 11:38:51 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime-style-2" data-cursor="-opaque">Ministries</h1>
    ...
    <div class="page-ministries">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <!-- Ministries Item Start -->
                    <div class="ministries-item wow fadeInUp" data-wow-delay="0.75s">
                        <!-- Ministries Image Start -->
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                ...
                <div class="col-md-4">
                    <!-- Ministries Item Start -->
                    <div class="ministries-item wow fadeInUp" data-wow-delay="1s">
                        <!-- Ministries Image Start -->
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                ...
                <div class="col-md-4">
                    <!-- Ministries Item Start -->
                    <div class="ministries-item wow fadeInUp" data-wow-delay="1.25s">
                        <!-- Ministries Image Start -->
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
