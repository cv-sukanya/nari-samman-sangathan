...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/avenix/ministry-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2024 11:38:51 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime-style-2" data-cursor="-opaque">Prayer Ministry</h1>
						<nav class="wow fadeInUp">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html">home</a></li>
                                <li class="breadcrumb-item"><a href="#">ministry</a></li>
								<li class="breadcrumb-item active" aria-current="page">prayer ministry</li>
							</ol>
						</nav>
					</div>
					<!-- Page Header Box End -->
...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/avenix/ministry-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Aug 2024 11:38:53 GMT -->
</html>